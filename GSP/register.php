...
<head>
    ...
    <link rel="stylesheet" href="CSS/register.css?v=20260609">
...
<body class="auth-page auth-register-page">
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <p class="subtitle">Vul uw gegevens in om toegang te krijgen tot het portaal.</p>
            ...
            <form class="login-form" action="register_verwerk.php" method="POST">
                ...
                <div class="form-group auth-form-full">
                ...
                <div class="form-group auth-form-full register-role-only" id="leerling_klas_group">
                    <label for="klas">Klas</label>
                    <input type="text" id="klas" name="klas" placeholder="bijv. 6ADB">
                </div>

                <div class="form-group auth-form-full register-role-only" id="leerkracht_klassen_group" hidden style="display:none;">

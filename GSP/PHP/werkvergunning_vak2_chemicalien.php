...
<head>
    ...
    <link rel="canonical" href="<?= e(appBaseUrl() . '/PHP/werkvergunning_vak2_chemicalien.php') ?>">
    
    <!-- Open Graph / Social Media -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?= e(appBaseUrl() . '/PHP/werkvergunning_vak2_chemicalien.php') ?>">
    ...
    <link rel="stylesheet" href="../CSS/werkvergunning_vak2_chemicalien.css?v=20260608">

...
<head>
    ...
    <link rel="stylesheet" href="../CSS/werkvergunning_vak2_activiteiten.css?v=20260608">
...
<body data-user-role="<?= e($role) ?>">
    ...
    <main class="main-container">
        <div class="form-card">
            ...
            <!-- II.4 SCHADELIJKE OF GEVAARLIJKE STOFFEN -->
            <div class="form-section">
                <div class="section-header-row">
...
<script src="../JS/ja-nee-toggle.js"></script>
    ...
    <script>
        ...
        function setupGeenCheckbox(geenId, sectionPrefix) {
        ...
        // Setup voor elke sectie
        document.addEventListener('DOMContentLoaded', function() {
            setupGeenCheckbox('koud_geen', 'koud');
            setupGeenCheckbox('warm_geen', 'warm');
            setupGeenCheckbox('vervoer_geen', 'vervoer');
            setupGeenCheckbox('stoffen_geen', 'stoffen');
        });
    </script>
    </body>
</html>
